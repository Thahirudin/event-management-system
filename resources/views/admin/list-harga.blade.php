        ...
        <div class="col-sm-12">
            <div class="iq-card">
                <div class="iq-card-header d-flex justify-content-between">
                    ...
                    <div>
                        <a href="{{ route('admin-tambah-harga', ['id' => $event->id] ) }}" class="btn btn-primary">Tambah Harga</a>
                    </div>
                </div>
                            ...
                            <tbody>
                                @foreach ($hargas as $harga)
                                    <tr>
                                        ...
                                        <td><a href="{{ route('admin-edit-harga', ['id' => $harga->id]) }}"
                                                class="btn btn-info mr-3">Edit</a> <a onclick="confirmDelete(this)"
                                            data-url="{{ route('admin-hapus-harga', ['id' => $harga->id]) }}"
