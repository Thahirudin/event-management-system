...
@section('content')
    <div class="iq-card">
        ...
        <div class="iq-card-body">
            <form action="{{ route('organizer-store-harga', ['id' => $event->id]) }}" method="post" enctype="multipart/form-data">
                @csrf
                <div class="form-group">
                    <label for="id_event">Id Event</label>
                    <input type="text" class="form-control" id="id_event" name="id_event" readonly autocomplete="off" required value="{{ $event->id }}">
                    @error('id_event')
                ...
                <div class="form-group">
                    ...
                    <input type="text" class="form-control" id="nama_harga" name="nama_harga" autocomplete="off" required>
                    @error('nama_harga')
                        <div class="text-danger">{{ $message }}</div>
                    @enderror
                </div>
                ...
                <div class="form-group">
                    ...
                    <input type="number" class="form-control" id="jumlah_tiket" name="jumlah_tiket" autocomplete="off" required>
                    @error('jumlah_tiket')
                        <div class="text-danger">{{ $message }}</div>
                    @enderror
                </div>
