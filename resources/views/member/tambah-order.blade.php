    ...
    <div class="iq-card">
        ...
        <div class="iq-card-body">
            <div class="row">
                ...
                <div class="col-md-6">
                    <form action="{{ route('member-tambah-order', ['id' => $event->id]) }}" method="POST"
                        enctype="multipart/form-data">
                        @csrf
                        @method('POST')
                        <div class="form-group d-none">
                            <label for="member">Id Member</label>
                            <input type="text" class="form-control" id="member" name="id_member" value="{{ auth()->guard('member')->user()->id }}" readonly>
                        </div>
                        <div class="form-group d-none">
