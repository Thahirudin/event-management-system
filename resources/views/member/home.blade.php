...
<style>
    ...
    .card {
        ...
        overflow: hidden;
        position: relative;
        /* To ensure rounded corners work even with images */
    }
...
<div id="carouselExample" class="carousel slide" data-ride="carousel">
    <div class="carousel-inner">
        <div class="carousel-item active">
            ...
            <div class="carousel-caption d-none d-md-block text-left" style="position: absolute; top: 35%; left: 5%; transform: translateY(-50%); width: 40%;">
                <h5 style="font-size: 5em;">Gamelab Event</h5>
                <div class="mt-4">
                    <h2 style="font-family: 'Arial', sans-serif; font-size: 3em;">Event Countdown Timer</h2>
                    <div id="timer"></div>
                </div>
            </div>
        </div>
...
<div class="mt-5 text-center">
    ...
    <div class="row">
        ...
        <!-- Card 1 -->
        <div class="col-md-4 top-selling-card mb-3">
            <div class="card">
                <img src="https://media.istockphoto.com/id/1305198154/id/foto/konser-rock-kerumunan-bersorak-di-depan-lampu-panggung-berwarna-warni-terang.jpg?s=612x612&w=0&k=20&c=77VbhAGbydhUb4y7H9tRfm-q7P_LDWCCcg1tvT-ruOc=" class="card-img-top" alt="Event 1">
                <div class="card-body body-top-selling">
        ...
        <div class="col-md-4 top-selling-card mb-3">
            <div class="card">
                <img src="https://media.istockphoto.com/id/1305198154/id/foto/konser-rock-kerumunan-bersorak-di-depan-lampu-panggung-berwarna-warni-terang.jpg?s=612x612&w=0&k=20&c=77VbhAGbydhUb4y7H9tRfm-q7P_LDWCCcg1tvT-ruOc=" class="card-img-top" alt="Event 2">
                <div class="card-body body-top-selling">
